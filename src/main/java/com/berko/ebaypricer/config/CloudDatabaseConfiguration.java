package com.berko.ebaypricer.config;
...
@Configuration
@EnableMongoRepositories("com.berko.ebaypricer.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.berko.ebaypricer.config.dbmigrations");
